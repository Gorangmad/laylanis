    ...
    <section className="w-full bg-[#FFF5EE] py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h2 className="text-[#d94a4a] text-4xl lg:text-5xl mb-6 uppercase  ">
          ...
          <div className="w-32 h-0.5 bg-[#d94a4a] mx-auto mt-6"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {/* Quality Card */}
          <div className="bg-[#FFF5EE] p-8 md:p-4 lg:p-8 rounded-lg shadow-[0_4px_20px_rgba(217,74,74,0.15)] hover:shadow-[0_8px_30px_rgba(217,74,74,0.2)] transition-shadow duration-300 text-center text-base  md:text-sm 2xl:text-base 2xl:w-96">
            ...
            <h3 className="text-[#d94a4a] text-2xl lg:text-3xl mb-4 uppercase font-bold">
              QUALITY
            </h3>
