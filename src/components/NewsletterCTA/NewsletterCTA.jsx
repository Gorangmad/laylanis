...
const NewsletterCTA = () => {
  return (
    <section className="w-full bg-[#d94a4a] py-24 lg:py-32">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <form className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-2xl mx-auto">
            <input
              ...
              focus:outline-none focus:ring-2 focus:ring-[#8B2921] text-base"
              required
            />
            <button
              type="submit"
              className="w-full sm:w-auto px-12 py-4 rounded-sm border-2 border-[#f7f1e8] text-[#f7f1e8]
              hover:bg-[#f7f1e8] hover:text-[#d94a4a] transition-all duration-300 uppercase tracking-widest text-sm font-medium"
            >
              SUBMIT
            </button>
          </form>
